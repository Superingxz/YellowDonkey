 ...
 * 描述:     TODO
 */
public class AllBalancePresenter extends BasePresenter implements AllBalanceContract.Model {

    @Override
    public void getAllBalanceHeader(String date) {
        RetrofitClient.getService()
                ...
                .subscribe(new RxCallback<CurrentTodayHeaderBean>() {
                    ...
                    public void onSuccess(CurrentTodayHeaderBean data) {
                        ((AllBalanceFragment) mView).getAllBalanceHeader(data);
                    }
                });
    }
