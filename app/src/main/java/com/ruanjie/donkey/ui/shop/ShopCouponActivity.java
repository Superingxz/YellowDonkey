...
public class ShopCouponActivity extends ToolbarActivity {
    ...
    public static void start(Context context, int which) {
        Intent starter = new Intent(context, ShopCouponActivity.class);
...
//        starter.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
    ...
    protected void initialize() {
        ...
        for (int i = 0; i < mTitles.length; i++) {
            mFragments.add(ShopCouponFragment.newInstance(i));
        }
