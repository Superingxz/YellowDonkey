 ...
 * 文件名:   TencentMapFragment
 * 创建者:    QJM
 * 创建时间: 2019/8/1 15:29
 * 描述:     TODO
 */
@Deprecated
public class TencentMapFragment extends SupportMapFragmentCompat implements ISupportFragment {

    private final SupportFragmentDelegate DELEGATE = new SupportFragmentDelegate(this);

    protected FragmentActivity mActivity;

    public final TencentMapActivity getMapActivity() {
        return (TencentMapActivity) mActivity;
    }
