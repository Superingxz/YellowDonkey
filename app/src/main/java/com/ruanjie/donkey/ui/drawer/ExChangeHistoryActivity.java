...
public class ExChangeHistoryActivity extends ToolbarActivity {
    ...
    public static void start(Context context) {
        Intent starter = new Intent(context, ExChangeHistoryActivity.class);
        // starter.putExtra(F);
    ...
    protected Object getLayoutId() {
        return R.layout.activity_ex_change_history;
    }
    ...
    private void initTabDatas() {
        ...
        mTitles[0] = "当日";
        mTitles[1] = "当月";
        mFragments.add(ExCurrentTodayFragment.newInstance());
        mFragments.add(ExCurrentMonthFragment.newInstance());
