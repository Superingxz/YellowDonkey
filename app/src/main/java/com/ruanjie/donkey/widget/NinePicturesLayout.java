...
public class NinePicturesLayout extends FrameLayout implements View.OnClickListener {
    ...
    private void notifyDataChanged() {
        final List<String> thumbList = mDataList;
...
//        }
        ...
        for (int i = 0; i < iPictureList.size(); i++) {
            ...
            if (i < urlListSize) {
                ...
                iPicture.setBackgroundResource( R.drawable.shape_def_loading);
     ...
     * @param uri
     */
    private void loadPictures(ImageView iPicture, String uri) {
        ImageUtil.load(iPicture, uri);
    }
    ...
    public void onClick(View v) {
        if (mCallback != null) {
            ...
            mCallback.onItemClick((ImageView) v, index);
        }
    }
