...
//            @Part("code") RequestBody code
    ...
    Observable<BaseBean<RechargeBean>> getPayOrderData(@Field("pay_type") int pay_type, @Field("coupon_id") int coupon_id);
    ...
    Observable<BaseBean<List<ParkingListBean>>> getParkingListData(
    ...
    Observable<BaseBean<List<CouponBean>>> getCoupons(@FieldMap Map<String, Object> params);
    ...
    @POST(HostUrl.GET_SHOP_BANNERS)
    Observable<BaseBean<List<String>>> getShopBanners(
    );

    @FormUrlEncoded
    @POST(HostUrl.GET_SHOP_SORTS)
    Observable<BaseBean<List<ShopSortBean>>> getShopSorts(
            @Field("pid") int pid
    );

    @FormUrlEncoded
    @POST(HostUrl.GET_SHOP_LIST)
    Observable<BaseBean<List<ShopsBean>>> getShopList(
            @Field("lng") String lng,
            @Field("lat") String lat,
    ...
    @FormUrlEncoded
    @POST(HostUrl.GET_SHOP_LIST)
    Observable<BaseBean<List<ShopsBean>>> getShopList2(
            @Field("lng") String lng,
            @Field("lat") String lat,
            @Field("category_id") int category_id,
            @Field("sort") int sort,
    ...
    @FormUrlEncoded
    @POST(HostUrl.GET_SHOP_DETAIL)
    Observable<BaseBean<ShopDetailBean>> getShopDetail(
            @Field("store_id") int store_id
    );

    @FormUrlEncoded
    @POST(HostUrl.BUY_GOODS)
    Observable<BaseBean<BuyGoodsBean>> buyGoods(
            @Field("goods_id") int goods_id
    );

    @FormUrlEncoded
    @POST(HostUrl.GET_COUPON_LIST)
    Observable<BaseBean<List<ShopCouponBean>>> getCouponList(
            @Field("type") int type,
            @Field("store_id") int store_id,
            @Field("page") int page,
            @Field("pageSize") int pageSize
    ...
    @FormUrlEncoded
    @POST(HostUrl.EXCHANGE_COUPON)
    Observable<BaseBean<BuyGoodsBean>> exchangeCoupon(
            @Field("coupon_id") int coupon_id
    );

    @FormUrlEncoded
    @POST(HostUrl.GET_GOODS_DETAIL)
    Observable<BaseBean<GoodsDetailBean>> getGoodsDetail(
            @Field("goods_id") int goods_id
    );


    @FormUrlEncoded
    @POST(HostUrl.GET_APPRAISE_LIST)
    Observable<BaseBean<List<ShopAppraiceBean>>> getAppraiseList(
            @Field("store_id") int store_id,
            @Field("page") int page,
            @Field("pageSize") int pageSize
    );
     ...
     */
    @FormUrlEncoded
    @POST(HostUrl.GET_SHOP_ORDER_LIST)
    Observable<BaseBean<List<ShopOrderBean>>> getShopOrderList(
            @Field("type") int type,
            @Field("status") int status,
            @Field("page") int page,
            @Field("pageSize") int pageSize
    ...
    @FormUrlEncoded
    @POST(HostUrl.SUBMIT_ORDER)
    Observable<BaseBean<String>> submitOrder(
            @Field("order_id") int order_id
    );

    @FormUrlEncoded
    @POST(HostUrl.DELETE_ORDER)
    Observable<BaseBean<String>> deleteOrder(
            @Field("order_id") int order_id
    );

    @FormUrlEncoded
    @POST(HostUrl.APPRAICE_GOODS)
    Observable<BaseBean<String>> appraiceGoods(
            @Field("order_id") int order_id,
            @Field("star") int star,
            @Field("content") String content,
    ...
    @FormUrlEncoded
    @POST(HostUrl.GET_COIN_LIST)
    Observable<BaseBean<List<ShopCoinBean>>> getCoinList(
            @Field("page") int page,
            @Field("pageSize") int pageSize
    );

    @FormUrlEncoded
    @POST(HostUrl.UPLOAD_IMAGES_BASE64_2)
    Observable<BaseBean<UploadBean2>> uploadImage2(
            @Field("content") String content,
            @Field("return_array") int return_array
    );
}
