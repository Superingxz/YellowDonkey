...
public class BindPhoneParameterInterceptor implements Interceptor {
    private static final String TAG = BindPhoneParameterInterceptor.class.getSimpleName();
    String mUser_id; String mToken;
    public BindPhoneParameterInterceptor(String user_id, String token) {
        mUser_id = user_id;
        mToken = token;
    }
